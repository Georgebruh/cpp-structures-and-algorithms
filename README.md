...
| **[Deque](./Interfaces/deque.hpp)** | Double-ended queue; insert/remove at both ends | [`Array Deque`](./Implementations/array_deque.cpp) | [`array_deque_app`](./Applications/array_deque_app.cpp) | random ahhh|

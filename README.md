...
| **Deque** | Double-ended queue; insert/remove at both ends | [`deque.hpp`](./Interfaces/deque.hpp) | [`Array Deque`](./Implementations/array_deque.cpp) | [`array_deque_app`](./Applications/array_deque_app.cpp) | VIP Queue Manager |
...
| **Graph** | Collection of vertices (nodes) and edges (connections) | [`graph.hpp`](./Interfaces/graph.hpp) | [`Adjacency Matrix`](./Implementations/adjacency_matrix.cpp) | [`adjacency_matrix_application`](./Applications/adjacency_matrix_application.cpp) | Regional Flight Manager |

...
| **Graph** | Collection of vertices (nodes) and edges (connections) | [`Adjacency Matrix`](./Implementations/adjacency_matrix.cpp) | [`adjacency_matrix_application`](./Applications/adjacency_matrix_application.cpp) | Regional Flight Manager |